...
export const ACCOUNT_WATCHLIST = process.env["ACCOUNT_WATCHLIST"] ? process.env["ACCOUNT_WATCHLIST"]?.split(";") : [];

export const ALERT_CONFIG = alertConfig;

export const DISCORD_USER_ID_LIST = process.env["DISCORD_USER_ID_LIST"] ? process.env["DISCORD_USER_ID_LIST"]?.split(";") : [];
